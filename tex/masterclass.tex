...
\item[\faGlobe{}] \texttt{\href{https://www.kaggle.com/datasets/waqi786/stars-dataset/data}{kaggle/waqi786/stars-dataset/}}
\end{itemize}

\begin{minipage}{0.45\textwidth}
\includegraphics[width=0.8\textwidth]{img/stars.png}
\end{minipage}
\begin{minipage}{0.45\textwidth}
\includegraphics[width=0.8\textwidth]{img/moons.png}
\end{minipage}
\includegraphics[width=0.8\textwidth]{img/planets.png}
...
\faGlobe{} \texttt{\url{https://pola.rs/}}
...
Aims to provide lightweight syntax for defining templates for RDF.\\Serialising chunks of data in a defined pattern. \faGlobe{} \texttt{\url{https://ottr.xyz/}}
\end{minipage}
...
A type, like the type of a term, is either a basic type, a list type or a LUB-type (least upper bound).
...
Remember our \texttt{df\_planet} data frame, with selected columns: \texttt{planet}, \texttt{planet\_uri}, \texttt{mean\_temperature}, \texttt{length\_of\_day}, and \texttt{orbital\_period}.
...
\textbf{Software:} Protégé --- \url{https://protege.stanford.edu/}
...
\textbf{Framework} for Python: \url{https://datatreehouse.github.io/maplib}
...
\begin{frame}[fragile]{Graph patterns}
\begin{code}
\begin{verbatim}
SELECT *
WHERE {
...
\textbf{Triple store} Apache Jena Fuseki -- \url{https://jena.apache.org/documentation/fuseki2/}
\end{frame}

\begin{frame}[fragile]{Federation}
\begin{code}
\begin{verbatim}
##### FEDERATED TO WIKIDATA
SELECT DISTINCT ?kommune ?population  
WHERE {
  ?s :kommune ?kommune .
...
\begin{frame}{Tools \& Resources}

\begin{tabular}{rll}
\textbf{Ontology modeling}&Protégé & \url{https://protege.stanford.edu/}\\
\textbf{Mapping}&OTTR &\url{https://ottr.xyz/}\\
\textbf{Data engineering framework}&maplib &\url{https://datatreehouse.github.io/maplib}\\
\textbf{Triple store \& SPARQL endpoint}&Apache Jena Fuseki &\url{https://jena.apache.org/}\\
\end{tabular}

\vspace{10pt}

\begin{tabular}{rl}
\textbf{Talk}&\url{https://github.com/veleda/there-is-more-to-life-than-sql}\\
\textbf{Free online training}&\url{https://open.hpi.de/courses/knowledgegraphs2023}\\
\textbf{Open data from public organisations}&\url{https://data.norge.no/nb}\\
\end{tabular}

\vspace{10pt}

\begin{tabular}{rl}
\textbf{Learn more on SPARQL}&\url{https://kvistgaard.github.io/sparql/}\\
\textbf{Play with SPARQL!}&\url{https://query.wikidata.org/}\\
\end{tabular}

\begin{center}
\textbf{Knowledge Graph Oslo Meetup} \url{https://www.meetup.com/knowledge-graph-oslo/}
\end{center}
